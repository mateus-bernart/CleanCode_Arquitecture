...
import type { CompilerInstance, TsJestTransformerOptions, TsJestTransformOptions } from 'ts-jest/dist/types';
...
export declare class TsJestTransformer implements SyncTransformer<TsJestTransformerOptions> {
    ...
    private _depGraphs;
    private _watchMode;
    constructor(tsJestConfig?: import("ts-jest/dist/types").TsJestGlobalOptions | undefined);
    private _configsFor;
